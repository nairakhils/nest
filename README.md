...
- **SoA data layout** for optimal vectorization and GPU coalescing
- **Patch-based decomposition** with precomputed neighbor exchange
- **Pipeline execution model** (Exchange → Compute → Reduce stages)
- **Backend-agnostic numerics** written once, run on CPU or GPU

## Getting Started

```bash
# Configure and build a CPU release
...
See [docs/CUDA_BACKEND.md](docs/CUDA_BACKEND.md) for GPU implementation details.
...
Figures are saved to `python/figures/`. See [python/README.md](python/README.md) for details.
...
- [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) - Overall design and architecture
- [docs/CUDA_BACKEND.md](docs/CUDA_BACKEND.md) - GPU implementation details
- [docs/CORE_TYPES.md](docs/CORE_TYPES.md) - Core data structures
- [docs/EULER_SOLVER.md](docs/EULER_SOLVER.md) - 1D Euler solver details
